...
class StoreLandingBlockRequest extends FormRequest
{
    ...
    {
        return [
            'block_type' => 'required|string|max:50|in:hero,collection_grid,featured_products,story,comparison,testimonials,faq,cta_banner,trust_bar',
